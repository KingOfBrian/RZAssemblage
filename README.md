...
RZAssemblage *friends  = [RZAssemblage assemblageForFetchedResultsController:friendListFRC];
RZAssemblage *filteredFriends  = [[RZFilterAssemblage alloc] initWithAssemblage:friends];
